...
int shift()
{
	...
	{		
		rgbImage[i*CAMERA_WIDTH+AXIS_START+1].red = 255*buffer[i];
		rgbImage[i*CAMERA_WIDTH+AXIS_START+1].green = 255*buffer[i];
		rgbImage[i*CAMERA_WIDTH+AXIS_START+1].blue = 255*buffer[i];
	}
	//count++;
